...
class MembersCursor(JSONCursor):
      ...
      def __init__(self, path_to_packets, key, employee_number,
                   title, create_new_key=False):
...
class ProjectsCursor(JSONCursor):
      ...
      def __init__(self, path_to_packets, key, pta, sponsor,
                   irb_number, create_new_key=False):
